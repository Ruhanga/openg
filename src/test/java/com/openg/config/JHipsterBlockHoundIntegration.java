...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.openg.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.openg.security.DomainUserDetailsService", "createSpringSecurityUser");
